...
const faqs = [
  ...
  <div
    className="
      ...
      pt-16 xl:pt-20 2xl:pt-20
    "
  >
    {/* HEADING */}
    <div className="text-center ">
      <p className="text-[16px] text-[#E7000B] font-semibold">
        FEATURES EXPLORED
      </p>
  ...
  >
   ...
   <div className="bg-black overflow-x-hidden pb-10">
  <div
    className="
      slide-up
      min-h-[80vh]
  ...
  >
    ...
    {/* HEADING */}
    <div className="text-center ">
      <p className="text-[14px] sm:text-[18px] text-[#E7000B]">
        Testimonials
      </p>
    ...
    >
      ...
      <div
        className="
          ...
          group
          overflow-hidden border border-zinc-300
        "
      >
        <div className="w-full sm:flex-1 p-6 lg:p-8">
          <h1 className="text-[18px] lg:text-[20px] mb-3 text-[#E7000B] font-semibold">
          ...
          <p className="mt-6 lg:mt-10 text-[16px] text-[#E7000B] font-semibold">
            Brooklyn Simmons
          </p>
  ...
  >
    ...
    <div className="text-center mt-10">
      <p className="text-[14px] sm:text-[16px] text-[#E7000B] font-semibold">
        FAQ's
      </p>
