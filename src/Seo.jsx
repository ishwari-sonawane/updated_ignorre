  ...
  <div className="max-w-[1600px] w-full px-4 sm:px-6 lg:px-8">
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4 mt-6">
        <div className="h-14 w-full sm:w-[180px] rounded-2xl flex items-center justify-center border border-red-600 bg-gradient-to-b from-red-600 via-red-700 to-red-800 hover:brightness-110 transition">
      ...
      <div className="hidden lg:block">
        ...
        <div className="absolute top-[320px] left-[30px] xl:left-[60px] w-[220px] xl:w-[260px] bg-zinc-100 p-3 rounded-2xl abc">
          <div className="flex items-center gap-2 bg-white w-15 rounded-xl p-1">
            <FaGlobe className="text-zinc-950" size={20} />
            <p className="text-zinc-950">SEO</p>
          </div>
        ...
        <div className="absolute top-[500px] left-[20px] xl:left-[40px] w-[220px] xl:w-[260px] bg-zinc-100 p-3 rounded-2xl abc">
          <div className="flex items-center gap-2 bg-white w-40 rounded-xl p-1">
            <MdEmail className="text-zinc-950" size={20} />
            <p className="text-zinc-950">Email Marketing</p>
          </div>
        ...
        <div className="absolute top-[320px] right-[30px] xl:right-[60px] w-[220px] xl:w-[260px] bg-zinc-100 p-3 rounded-2xl abc">
          <div className="flex items-center gap-2 bg-white w-35 rounded-xl p-1">
            <RiInstagramFill className="text-zinc-950" size={20} />
            <p className="text-zinc-950">Social Media</p>
          </div>
        ...
        <div className="absolute top-[500px] right-[20px] xl:right-[40px] w-[220px] xl:w-[260px] bg-zinc-100 p-3 rounded-2xl abc">
          <div className="flex items-center gap-2 bg-white w-25 rounded-xl p-1">
            <IoMdPricetag className="text-zinc-950" size={20} />
            <p className="text-zinc-950">Brand</p>
          </div>
...
<section id="features" className='bg-white 2xl:-mt-30 2xl:pb-10 abc'>
     <div className="slide-up flex flex-col justify-center items-center  2xl:pt-40 px-4">
    <button className="border border-zinc-300 p-2 rounded-3xl w-32 sm:w-35 text-zinc-950 mt-5">
      SEO Features
    </button>

    <h1 className="reveal-text text-[32px] sm:text-[40px] 2xl:text-[48px] font-bold text-center mt-5 text-zinc-950">
      Create SEO Content that <br />
      <span className="text-[rgba(74,106,253,1)]">Drives Rankings</span>
    </h1>

    <p className="reveal-text text-[15px] sm:text-[17px] 2xl:text-[18px] text-zinc-950 font-medium mt-5 text-center">
        ...
        <div className='flex flex-col lg:flex-row justify-center gap-8 2xl:gap-5 mt-12 2xl:mt-15 items-center px-4'>
          <div>
              <div className='slide-up h-auto lg:h-75 2xl:h-75 w-90 ml-5 sm:w-[90%] md:w-[80%] lg:w-[500px] 2xl:w-140 bg-white border border-zinc-200 rounded-2xl shadow-xl p-5 mx-auto'>
                <p className='reveal-text text-[14px] text-zinc-400 mt-3'>Keyword-Optimized Content</p>
                ...
                <p className='reveal-text text-[14px] text-zinc-400 mt-5'>Analyze search intent, keyword difficulty, and SERP competitors before creating <br/>content.</p>
                 <div className='p-4 mt-4 rounded-2xl flex items-center justify-center bg-gradient-to-b from-red-600 via-red-700 to-red-800 hover:brightness-110 transition'>
            <button className='text-[18px] text-white font-semibold'>Continue</button>
        </div>
            </div>
            <p className='slide-up reveal-text text-[20px] 2xl:text-[24px] font-semibold mt-5 mb-3 text-center lg:text-left lg:ml-5 text-zinc-950'>Research & Insights</p>
            ...
            <p className='slide-up reveal-text text-[20px] 2xl:text-[24px] font-medium mt-5 mb-3 text-center lg:text-left text-zinc-950'>Optimize & Refine</p>
    ...
    <div className='flex flex-col lg:flex-row justify-center gap-8 2xl:gap-5 mt-12 2xl:mt-15 items-center px-4'>
          <div className="2xl:ml-12 lg:ml-20">
              <div className='slide-up lg:h-75 2xl:h-65 w-full sm:w-[90%] lg:w-[500px] 2xl:w-140 bg-white border border-zinc-200 rounded-2xl shadow-xl p-5 lg:ml-5 xl:ml-0'>
                <p className=' text-[20px] mt-3 mb-5 font-medium text-zinc-950'>Organic Search Growth</p>
                <img src={traffic} alt="" />
            ...
            <p className='slide-up reveal-text text-[20px] 2xl:text-[24px] font-medium mt-5 mb-3 text-center lg:text-left text-zinc-950'>Publish & Optimize</p>
          ...
          <div>
              <div className='slide-up lg:h-75 2xl:h-65 w-full sm:w-[90%] lg:w-[500px] 2xl:w-140 bg-white border border-zinc-200 rounded-2xl shadow-xl p-5 lg:ml-5 xl:ml-0'>
                <p className='text-[20px] text-zinc-950 mt-3 font-medium'>SEO Content Score</p>
            ...
            <p className='slide-up reveal-text text-[20px] 2xl:text-[24px] font-medium mt-5 mb-3 text-center lg:text-left text-zinc-950'>SEO Performance Tracking</p>
...
<div className="bg-white abc">
  ...
  >
    ...
    <div className="text-center lg:text-left">
      <button className="text-[14px] font-medium border border-zinc-300 rounded-3xl p-2 px-3 text-zinc-950">
        AI SEO Platform
      </button>
      ...
      <div className="h-14 w-full sm:w-60 lg:w-50 mt-5 rounded-2xl flex items-center justify-center border border-blue-700 bg-gradient-to-b from-red-600 via-red-700 to-red-800 hover:brightness-110 transition mx-auto lg:mx-0">
    ...
    >
      ...
      <p className="text-[15px] lg:text-[16px] text-zinc-400 font-medium mt-3 text-center lg:text-left">
...
<div className="flex flex-col justify-center items-center text-center pt-24 lg:pt-60 px-4 bg-white abc">
...
<div className="bg-white abc">
  ...
  >
    ...
    <p className="reveal-text text-[28px] sm:text-[36px] lg:text-[48px] font-bold text-zinc-950 mt-4">
      ...
      <br className="hidden sm:block" />
      performance with{" "}
      <span className="text-zinc-950">AI-driven insights</span>.
    </p>
...
<section id="testimonials" className='bg-white abc'>
  <div className='flex flex-col justify-center items-center text-center pt-50'>
     <button className='text-[14px] font-medium border-1 border-zinc-300 rounded-3xl p-2 pl-3 pr-3 text-zinc-950'>Testimonial</button>
   ...
   <div className="max-w-6xl mx-auto mt-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-15">
      {testimonials.map((item, i) => (
        ...
        >
          ...
          {/* CONTENT */}
          <p className="font-bold text-zinc-950 text-[16px]">{item.name}</p>

          <p className="mt-2 text-[16px] font-medium text-zinc-600">
            {item.text}
          </p>

          <p className="mt-3 text-[16px] font-bold text-zinc-950">
            {item.role}
          </p>
        </div>
      ))}
...
<section id="pricing" className='bg-white abc'>
  {/* HEADER */}
  <div
    className="
      slide-up
  ...
  >
    <div>
      ...
      <p className="reveal-text text-[32px] sm:text-[40px] lg:text-[48px] text-zinc-950 font-bold mt-3">
     ...
     <div className="price-card border border-zinc-200 w-full sm:w-[90%] md:w-[380px] lg:w-95 h-auto lg:h-155 flex flex-col gap-5 shadow-2xl rounded-xl p-5 bg-white">
       ...
       <div className='flex gap-2'><IoCheckboxSharp size={20} className='text-white bg-zinc-950'/> <p className='text-[16px] text-zinc-500 font-medium'>Site audit (basic)</p></div>
        ...
        <div className='flex items-center justify-center'>
          <button className='text-[16px] text-white rounded-2xl w-80 h-13 border-blue-700 bg-gradient-to-b from-red-600 via-red-700 to-red-800 hover:brightness-110 transition'>Choose This</button>
        </div>
      </div>

       <div className="price-card border-2 border-zinc-200 w-full sm:w-[90%] md:w-[380px] lg:w-95 h-auto lg:h-155 flex flex-col gap-5 shadow-2xl rounded-xl p-5 bg-white">
        <p className='text-[24px] text-zinc-950 font-bold'>Pro</p>
        <p className='text-[14px] text-zinc-500 font-medium'>Best for growing businesses and SEO teams.</p>
        <div className='flex gap-4'>
          <p className='text-[48px] text-zinc-950 font-bold'>
           ${pricing[active].pro}
            </p>
          <p className='text-[14px] text-zinc-500 font-medium mt-6'>(billed monthly)</p>
        </div>
        <p className='text-[16px]'>Plan includes:</p>
         <div className='flex gap-2'><IoCheckboxSharp size={20} className='text-white bg-zinc-950'/> <p className='text-[16px] text-zinc-500 font-medium'>Advanced AI SEO insights</p></div>
        <div className='flex gap-2'><IoCheckboxSharp size={20} className='text-white bg-zinc-950'/> <p className='text-[16px] text-zinc-500 font-medium'>Full competitor analysis</p></div>
         <div className='flex gap-2'><IoCheckboxSharp size={20} className='text-white bg-zinc-950'/> <p className='text-[16px] text-zinc-500 font-medium'>Content optimization with search intent</p></div>
        <div className='flex gap-2'><IoCheckboxSharp size={20} className='text-white bg-zinc-950'/> <p className='text-[16px] text-zinc-500 font-medium'>Track up to 2,000 keywords</p></div>
         <div className='flex gap-2'><IoCheckboxSharp size={20} className='text-white bg-zinc-950'/> <p className='text-[16px] text-zinc-500 font-medium'>5 SEO projects</p></div>
        <div className='flex gap-2'><IoCheckboxSharp size={20} className='text-white bg-zinc-950'/> <p className='text-[16px] text-zinc-500 font-medium'>Team collaboration & user management</p></div>
        <div className='flex items-center justify-center'>
          <button className='text-[16px] text-white rounded-2xl w-80 h-13 border-blue-700 bg-gradient-to-b from-red-600 via-red-700 to-red-800 hover:brightness-110 transition'>Choose This</button>
        </div>
      </div>
 ...
 <div className="flex justify-center items-center mt-10 px-4">
    <div
      ...
      <div className="text-center lg:text-left">
        ...
        <button className="mt-4 text-[16px] text-white rounded-2xl w-full sm:w-50 h-13 border-blue-700 bg-gradient-to-b from-red-600 via-red-700 to-red-800 hover:brightness-110 transition">
          Apply Now
        </button>
      </div>
...
<div className='bg-white abc'>
  ...
  >
    ...
    <div className="flex flex-col gap-6 items-center lg:items-start">
      ...
      <button className="text-[16px] text-white rounded-2xl w-full sm:w-50 h-13 border-blue-700 bg-gradient-to-b from-red-600 via-red-700 to-red-800 hover:brightness-110 transition">
        Start SEO Analysis
      </button>
    </div>
  </div>
...
<div className='bg-white abc'>
  ...
  >
    ...
    <div className="h-auto w-full sm:w-[95%] md:w-[520px] lg:w-[500px] border border-zinc-200 rounded-2xl shadow-2xl p-5 lg:p-7 bg-white">
      <p className="text-[22px] lg:text-[24px] text-zinc-950 mb-2 font-bold">
        Ignorre SEO
      </p>
...
<section id="faq" className='bg-white abc'>
 ...
 <section className="w-full pt-24 lg:pt-50 bg-white flex items-center justify-center abc">
  <div
    className="
      slide-up
      relative
  ...
  >
    ...
    <div className="text-center lg:text-left lg:ml-20">
      ...
      <h1 className="reveal-text text-[32px] sm:text-[40px] lg:text-[48px] leading-tight font-bold text-zinc-950 mt-4">
        We’re Here to Help
        <br className='hidden '/> 
      ...
      <div className="mt-8 lg:mt-10">
        <p className="font-semibold text-zinc-950 mb-2">Office Hours</p>
        <p className="text-zinc-950 text-[15px] lg:text-[16px] font-medium">
