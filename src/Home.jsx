...
<section className="w-full min-h-[95vh] flex items-center justify-center bg-white abc py-12">
  <div className="text-center max-w-4xl w-full px-4 sm:px-6">
    ...
    <header className="pt-24 pb-16 px-6 text-center">
      <motion.span
        ...
        className="text-zinc-950 font-semibold text-sm tracking-wider uppercase mb-6 block border border-zinc-200 w-fit mx-auto py-2 rounded-full px-6 "
      >
        Products
      </motion.span>
      <motion.h1
        initial={{ opacity: 0, y: 10 }}
              ...
              className="text-4xl md:text-6xl font-bold text-zinc-950 mb-6"
            >
      ...
      <a href="/product"> <button className="-mt-5 mb-10 sm:mb-15 bg-red-600 hover:bg-red-700 text-white font-medium py-3 px-8 rounded-full transition-all transform hover:scale-105 flex items-center gap-3">
        ...
        <span className="text-zinc-950 text-sm font-semibold tracking-wide uppercase abc border border-zinc-200 w-fit mx-auto py-2 rounded-full px-6">
          Features
        </span>
       ...
       <motion.div 
        ...
        <a href="#" className="text-zinc-950 text-xs font-bold tracking-wider uppercase abc border border-zinc-200 w-fit mx-auto py-2 rounded-full px-6">
         Testimonials
        </a>
 ...
 <a href="/testimonial"> <button className="mt-0 mb-10 sm:mb-15 bg-red-600 hover:bg-red-700 text-white font-medium py-3 px-8 rounded-full transition-all transform hover:scale-105 flex items-center gap-3">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="mt-12 text-center">
                <p className="text-zinc-500 text-[16px] font-semibold abc">
                  ...
                  <a href="/contact" className="text-zinc-950 text-[16px] font-semibold abc">
