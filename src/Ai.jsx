...
{/* <FloatingSupportContact /> */}
  ...
  <div className="w-full bg-white Gfont abc overflow-x-hidden">
  <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
    ...
    {isMobile ? (
      ...
      <div className="flex flex-col py-12">
        ...
        <div className="w-full">
          ...
          <div className="mt-6 text-[14px] text-zinc-950">
            <p>
      ...
      <div className="flex flex-col md:flex-row items-start justify-between py-12">
        ...
        <div className="w-full md:w-[35%] flex flex-col justify-center">
          ...
          <div className="mt-8 text-[16px] text-zinc-950">
            <p>
              Experience how ignorre.ai brings together
              <br />
        ...
        <div className="w-full md:w-[62%] mt-10 md:mt-0">
          ...
          <div className="font-semibold text-[28px] text-zinc-950 md:mb-41 lg:mb-25">
            <h1>
      ...
      <div className="flex flex-col xl:flex-row items-start justify-between min-h-screen py-16">
        ...
        <div className="slide-up w-full xl:w-[30%] flex flex-col justify-center">
          ...
          <div className="mt-12 text-[18px] text-zinc-950">
            <p>
              Experience how ignorre.ai brings together
              <br />
              conversational AI, real-time search, and
          ...
          <div className="w-full flex flex-col justify-center items-center gap-10">
            ...
            <div className="w-full flex flex-col lg:flex-row gap-5 mb-5">
              ...
              <div className="h-full w-full lg:w-165 border border-zinc-200 rounded-2xl overflow-hidden bg-white mt-5">
                ...
                <h3 className="ml-6 text-[26px] font-semibold text-zinc-950 leading-tight">User Satisfaction</h3>
            ...
            <div className="w-full flex flex-col lg:flex-row gap-5">
              <div
                ...
                <div className="relative z-10 ">
                  ...
                  <p className="text-[26px] text-zinc-950 font-semibold">Teams Onboarded</p>
            ...
            <div className="flex flex-col group cursor-pointer ml-0 lg:ml-185 mt-10 items-center md:items-start">
              <a href="/about">
                <div className="flex items-center">
                  <p className="text-[18px] text-zinc-950 font-sans font-semibold mb-2">
                    Get to Know More
                  </p>
                  {/* Arrow rotates on hover */}
                  <MdOutlineArrowOutward
        ...
        {cardsData.map((card, i) => (
          ...
          >
            ...
            <div className="text-start text-black ml-3 mb-5">
              ...
              <div className="text-[18px] opacity-80 text-zinc-950 font-bold">{card.desc}</div>
...
<div className="Gfont  w-full flex flex-col items-center -mt-30 bg-white px-4 sm:px-6 abc">
  ...
  <div className="slide-up text-center h-auto lg:h-80 w-full mt-5 px-2 abc md:pt-40">
    ...
    <h1 className=" text-[26px] sm:text-[32px] lg:text-[44px] font-semibold mb-5 mt-4 text-zinc-950">
      Choose the Right Plan for Your AI Journey
    </h1>
    <p className="text-[14px] sm:text-[16px] lg:text-[18px] text-zinc-950">
  ...
  {isMobile || isTablet ? (
    ...
    <div className="bg-white min-h-screen w-full overflow-x-hidden Gfont abc">
  <div
    className="
      max-w-7xl
      mx-auto
...
{/* ninth page */}
    ...
    <div className="min-h-screen bg-white Gfont abc overflow-x-hidden">
  <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
    ...
    >
      {/* Left Small Heading */}
      <div className="flex items-center gap-3 text-zinc-950 text-[16px] sm:text-[18px] font-semibold mt-5">
        <FaEye />
      ...
      <div className="mt-6 lg:mt-0 lg:max-w-[850px]">
        <h1 className="text-[30px] sm:text-[38px] lg:text-[44px] font-semibold text-zinc-950">
          Discover the Future of AI in Business
        </h1>

        <p className="text-[15px] sm:text-[16px] lg:text-[18px] text-zinc-950 mt-3">
    ...
    {/* BUTTON */}
    <a href="#">
      <div className="flex items-center justify-center group mt-10 text-zinc-950">
    ...
    <div className="w-[130px] h-[1.5px] bg-zinc-950 mx-auto mt-3 mb-10"></div>
      ...
      <div className="min-h-screen lg:min-h-0 xl:-mt-15 lg:mt-0 Gfont lg:mb-0 bg-white abc">
        ...
        mx-auto my-20 lg:my-0">
              <div className="flex lg:-mt-0 gap-2 text-zinc-950"><LuMessageCircleMore size={25} /> <p className="text-[16px] lg:text-[18px]">Let’s Connect</p></div>
              <h1 className="mt-5 lg:mt-5 text-[30px] md:text-[36px] lg:text-[44px] font-semibold text-zinc-950">Start the Conversation Today</h1>
              <p className="mt-6 lg:mt-5 text-[14px] md:text-[16px] lg:text-[18px] leading-relaxed text-zinc-500">“At Vayuna, we believe every business deserves the power of AI—whether you're just starting or<br /> scaling fast. My team and I are here to support your vision and help you move forward with<br /> confidence.”</p>
              <div className="mt-8 lg:mt-10">
                <img src={ceo} alt="" className="rounded-full object-cover h-12 w-12 lg:h-15 lg:w-15" />
              </div>
              <h5 className="text-[14px] lg:text-[15px] font-semibold mt-4 lg:mt-5 text-zinc-950">Anup Gosavi</h5>
              <p className="text-[14px] lg:text-[15px] text-zinc-500">Founder & CEO of Vayuna Voicetech Pvt Ltd</p>
              <div className="flex flex-col lg:flex-row mt-5 lg:mt-10 gap-4 lg:gap-4">
                <div className="group inline-flex items-center gap-0 self-center lg:self-auto">
                 ...
                 <a href="/contact">
                  <button
                    className="text-white px-6 py-3 text-[16px] lg:text-[18px] rounded-full font-semibold font-sans tracking-widest shadow-lg transition-all duration-500 bg-gradient-to-tr from-red-600 to-red-700">
                    Get Started Now
                  </button>
                 </a>
               ...
               <a href="/contact">
                <button className="group flex items-center gap-2 text-[16px] lg:text-[18px] text-zinc-950 px-6 py-3 font-sans rounded-full font-semibold tracking-widest shadow-lg transition-all duration-500 bg-white hover:bg-gray-700 hover:text-white hover:border-none self-center lg:self-auto">
                  Talk to Us
                  <MdOutlineArrowOutward
                    size={20}
