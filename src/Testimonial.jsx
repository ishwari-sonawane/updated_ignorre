  ...
  return (
    ...
    <section className="bg-white text-white py-24 min-h-screen flex flex-col justify-center relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 mb-16 text-center z-10">
        <a href="#" className="text-[#e90011] text-[14px] font-medium tracking-wider uppercase abc">
          Feedback From Our Users
        </a>
        <h2 className="text-3xl sm:text-5xl md:text-7xl font-bold mt-6 mb-8 tracking-tight text-zinc-950 abc">
