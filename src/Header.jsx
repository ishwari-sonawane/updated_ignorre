...
{/* <Link
                    ...
                    <Link
                        ...
                        className={`cursor-pointer flex items-center gap-1 ${active === "pricing" ? "text-red-600" : "text-zinc-700"
                            } hover:text-red-600`}
                    >
                        Pricing
                    </Link>
                    ...
                    <Link
                        ...
                        className={`cursor-pointer flex items-center gap-1 ${active === "testimonial" ? "text-red-600" : "text-zinc-700"
                            } hover:text-red-600`}
                    >
                        Testimonial
                    </Link>
                    ...
                    <Link
                        ...
                        className={`cursor-pointer flex items-center gap-1 ${active === "faq" ? "text-red-600" : "text-zinc-700"
                            } hover:text-red-600`}
                    >
                        FAQ
                    </Link>
                    ...
                    <Link
                        ...
                        className={`cursor-pointer flex items-center gap-1 ${active === "contact" ? "text-red-600" : "text-zinc-700"
                            } hover:text-red-600`}
                    >
                        Contact
                    </Link>
