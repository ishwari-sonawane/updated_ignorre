...
<div className="w-full bg-zinc-50 py-10 px-4">
  ...
  >
    ...
    <img src={logo6} alt="Logo 6" className="h-8 md:h-10 w-auto object-contain" />
      ...
      <div className='bg-white abc'>
        <div className="slide-up flex flex-col xl:flex-row items-center justify-center gap-2 2xl:pb-10">
          ...
          <div className="mt-10 px-6 sm:px-10 2xl:ml-0 2xl:mt-30 ">
            ...
            {/* CARD 1 */}
            <div className="slide-up w-full max-w-3xl flex flex-col sm:flex-row gap-5 p-5 bg-zinc-50 border-l-7 border-l-[#312C85] border border-zinc-200 rounded-2xl mt-20">
              <div className="bg-white h-15 w-15 flex items-center justify-center mt-3 p-4 rounded-full flex-shrink-0">
                <RiUserCommunityLine size={38} className="text-zinc-950" />
              </div>
              <div className="mt-3">
                <p className="text-[20px] sm:text-[22px] lg:text-[24px] text-zinc-950 font-medium">
            ...
            {/* CARD 2 */}
            <div className="slide-up w-full max-w-3xl flex flex-col sm:flex-row gap-5 p-5 bg-zinc-50 border-l-7 border-l-[#312C85] border border-zinc-200 rounded-2xl mt-5">
              <div className="bg-white h-15 w-15 flex items-center justify-center mt-3 p-4 rounded-full flex-shrink-0">
                <TbLockShare size={38} className="text-zinc-950" />
              </div>
              <div className="mt-3">
                <p className="text-[20px] sm:text-[22px] lg:text-[24px] text-zinc-950 font-medium">
            ...
            <div className="slide-up w-full max-w-3xl flex flex-col sm:flex-row gap-5 p-5 bg-zinc-50 border-l-7 border-l-[#312C85] border border-zinc-200 rounded-2xl mt-5">
              <div className="bg-white h-15 w-15 flex items-center justify-center mt-3 p-4 rounded-full flex-shrink-0">
                <FaHandshakeAngle size={38} className="text-zinc-950" />
              </div>
              <div className="mt-3">
                <p className="text-[20px] sm:text-[22px] lg:text-[24px] text-zinc-950 font-medium">
            ...
            <div className="slide-up w-full max-w-3xl flex flex-col sm:flex-row gap-5 p-5 bg-zinc-50 border-l-7 border-l-[#312C85] border border-zinc-200 rounded-2xl mt-5">
              <div className="bg-white h-15 w-15 flex items-center justify-center mt-3 p-4 rounded-full flex-shrink-0">
                <MdOutlineManageAccounts size={38} className="text-zinc-950" />
              </div>
              <div className="mt-3">
                <p className="text-[20px] sm:text-[22px] lg:text-[24px] text-zinc-950 font-medium">
      ...
      {/* ignorr product tabs */}
<div className='bg-white abc w-full overflow-hidden'>
  ...
  <div className="slide-up py-16 md:py-24 px-4 sm:px-10 max-w-7xl mx-auto">
    ...
    <p className="text-[32px] sm:text-[40px] lg:text-[48px] font-semibold text-zinc-950 text-center leading-tight">
    ...
    <div className="w-full mt-10 lg:mt-20">
      ...
      */}
      <div className="flex flex-col sm:flex-row sm:justify-center border-b border-zinc-200 mb-10 overflow-x-auto no-scrollbar"
        ...
        {tabs.map((tab, index) => (
          ...
          >
            ...
            <div className="flex flex-col gap-4 lg:gap-6 text-center lg:text-left items-center lg:items-start">
              ...
              <h2 className="text-[28px] sm:text-[34px] lg:text-[44px] font-bold text-zinc-950 leading-tight">
                {tab.title}
              </h2>
              ...
              <div className="mt-4">
                <a
                  ...
                  className="inline-block py-3 px-10 text-[18px] font-medium text-white rounded-xl bg-gradient-to-b from-zinc-800 via-zinc-800 to-zinc-900 transition-all duration-200 ease-out hover:brightness-125 hover:shadow-lg"
                >
                  {tab.button.text}
                </a>
              </div>
      ...
      {/* client reviews */}
<div className='bg-white abc w-full min-h-screen flex flex-col justify-center'>
  <div className="slide-up
    ...
    <div className="w-full text-center md:text-left">
      <p className="text-[32px] sm:text-[40px] lg:text-[48px] font-semibold text-zinc-950 leading-tight max-w-4xl">
      ...
      {[
        ...
        <div key={index} className="slide-up min-h-[380px] w-full max-w-[450px] bg-white border border-zinc-200 rounded-2xl p-6 flex flex-col justify-between shadow-sm">
          ...
          <div className="flex flex-col gap-4">
            <FaQuoteLeft size={28} className="text-zinc-950 flex-shrink-0" />
